  ...
  - [가운데 정렬](#가운데-정렬)
    ...
    - [세로 가운데 정렬](#세로-가운데-정렬)
      - [가짜 요소 더하기 (*vertical-align: middle;을 사용하면 될까?* 에 대한 고찰)](#①-가짜-요소-더하기)
        - [번외)만약 `.info`의 가로 길이가 100% 라면?](#번외]-만약-.info-의-가로-길이가-100%-라면?)
          - [첫 번째, 띄어쓰기 없애기](#첫-번째,-띄어쓰기-없애기)
          - [두 번째, 띄어쓰기 공간 만큼의 마이너스 여백 주기](#두-번째,-띄어쓰기-공간-만큼의-마이너스-여백-주기)
