...
`document` 프로퍼티 값을 `documentElement`로 주니까 

`scrollTop`가 너무 잘 작동된다. (아래 코드 참고)
...
<p align="center"><img src="https://user-images.githubusercontent.com/75716255/144749356-2d108c0d-bd46-49ac-9902-e73c2d74106a.png" width="60%"></p>
